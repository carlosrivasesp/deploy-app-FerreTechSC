...
export class PedidoService {
  ...
  obtenerClientePorDocumento(documento: string) {
    return this.http.get(`${this.apiUrl}/cliente/${documento}`);
  }

  actualizarEstadoPago(nroPedido: string, estadoPago: string) {
    return this.http.put(`${this.apiUrl}/${nroPedido}/estado-pago`, {
      estadoPago,
    });
  }
}
